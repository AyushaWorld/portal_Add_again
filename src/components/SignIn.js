                        ...
                        <div className="card-body">
                          ...
                          <div className="col-md-12"> 
                              <div className="form-group">
                                  ...
                                  <input type="name" onChange={(e)=> setName(e.target.value)} value={name}  placeholder="Enter name" className="form-control" id="name" name="name" required/>
                                  {/* <input onChange={(e)=> settitle(e.target.value)} type="username" value={Name} placeholder="Enter name" className="form-control" id="username" name="username" required=""/> */}
                              ...
                              <div className="form-group">
                                  ...
                                  <input onChange={(e)=> setemail(e.target.value)} type="email" value={email} placeholder="email" className="form-control" id="email" name="email" required/>
                                  <span style={{ fontSize: "12px", color: "red" }}>
                                  {!email && emailErr}
                                </span>
                              </div>
                          ...
                          <div className="col-md-12"> 
                              <div className="form-group">
                                ...
                                >
                                  ...
                                  <input onChange={(e)=> setPhone(e.target.value)} value={phone} type="number"  placeholder="Enter phone" className="form-control" id="phone" name="phone" required/>
                                  <span style={{ fontSize: "12px", color: "red" }}>
                                    {!phone && phoneErr}
                                  </span>
                              </div>
                          ...
                          <div className="col-md-12"> 
                              <div className="form-group">
                                  ...
                                  {/* <input type="timezone" onChange={(e)=> setTimezone(e.target.value)} value={timezone} placeholder="Enter timezone" className="form-control" id="timezone" name="timezone" required=""/> */}
                                      <select
